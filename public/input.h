...
public:
  ...
  static void readVectorItem(std::vector<int> &v, std::string msg,
                             std::string errMsg = "Invalid number\n") {
    v.push_back(readInt(msg, errMsg));
  }

  static void readVectorItem(std::vector<std::string> &v, std::string msg,
                             bool clearWhiteSpaces = true) {
    v.push_back(readString(msg));
  }
